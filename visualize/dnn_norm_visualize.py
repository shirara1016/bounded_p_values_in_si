...
# Unique
if not os.path.exists(path := "images/dnn_norm_images"):
    os.mkdir(path)


# Unique
def file_name(seed, num_samples, signal):
    return f"dnn_norm_seed{seed}_d{num_samples}_delta{signal}.pkl"


def open_file(seed=0, num_samples=16, signal=0.0):
...
def plot_fpr(alp=0.05, ymax=0.4):
    ...
    # Unique
    plt.savefig(
        f"images/dnn_norm_images/fpr_alpha{alp}.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_tpr(alp=0.05):
    ...
    # Unique
    plt.savefig(
        f"images/dnn_norm_images/tpr_alpha{alp}.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_time_null():
    ...
    # Unique
    plt.savefig(
        f"images/dnn_norm_images/time_null.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_time_alternative():
    ...
    # Unique
    plt.savefig(
        f"images/dnn_norm_images/time_alternative.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_count_under_null_compare_criteria():
    ...
    # Unique
    plt.savefig(
        f"images/dnn_norm_images/count_null_criteria.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_count_under_null_compare_strategy():
    ...
    # Unique
    plt.savefig(
        f"images/dnn_norm_images/count_null_strategy.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_count_under_alternative_compare_criteria():
    ...
    # Unique
    plt.savefig(
        f"images/dnn_norm_images/count_alternative_criteria.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_count_under_alternative_compare_strategy():
    ...
    # Unique
    plt.savefig(
        f"images/dnn_norm_images/count_alternative_strategy.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_count_box(num_samples=16, signal=0.0):
    ...
    # ax.set_title(f"Search Count (image size {num_samples} and signal {signal})")
    step = 1.1
    ...
    # Unique
    plt.savefig(
        f"images/dnn_norm_images/box_count_samples{num_samples}_signal{signal}.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
