...
# Unique
if not os.path.exists(path := "images/sfs_chi_images"):
    os.mkdir(path)


# Unique
def file_name(seed, num_samples, signal):
    return f"sfs_chi_seed{seed}_n{num_samples}_delta{signal}.pkl"
...
def plot_fpr(alp=0.05, ymax=0.4):
    ...
    for samples in samples_list:
        ...
        naive_p_list = results_dict["naive_p_values"]
        naive_fpr_list.append(np.mean(naive_p_list))
    ...
    # Unique
    plt.savefig(
        f"images/sfs_chi_images/fpr_alpha{alp}.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_tpr(alp=0.05):
    ...
    # Unique
    plt.savefig(
        f"images/sfs_chi_images/tpr_alpha{alp}.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_time_null():
    ...
    # Unique
    plt.savefig(
        f"images/sfs_chi_images/time_null.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_time_alternative():
    ...
    # Unique
    plt.savefig(
        f"images/sfs_chi_images/time_alternative.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_count_under_null_compare_criteria():
    ...
    # Unique
    plt.savefig(
        f"images/sfs_chi_images/count_null_criteria.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_count_under_null_compare_strategy():
    ...
    # Unique
    plt.savefig(
        f"images/sfs_chi_images/count_null_strategy.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_count_under_alternative_compare_criteria():
    ...
    # Unique
    plt.savefig(
        f"images/sfs_chi_images/count_alternative_criteria.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_count_under_alternative_compare_strategy():
    ...
    # Unique
    plt.savefig(
        f"images/sfs_chi_images/count_alternative_strategy.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
...
def plot_count_box(num_samples=200, signal=0.0):
    ...
    # Unique
    plt.savefig(
        f"images/sfs_chi_images/box_count_samples{num_samples}_signal{signal}.pdf",
        transparent=True,
        bbox_inches="tight",
        pad_inches=0,
    )
